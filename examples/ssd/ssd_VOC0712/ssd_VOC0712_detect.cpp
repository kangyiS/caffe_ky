 ...
 * video:      62fps(forward), 57fps(loop)
 * one image:  37fps(forward), 33fps(loop) 
 * images:     71fps(forward), 62fps(loop)
 * 
 */
...
//string source_file = "/home/kangyi/data/VOCdevkit/VOC2007/JPEGImages/000001.jpg";
...
string model_file = trainModel_dir + "/ssd_VOC0712_iter_120000.caffemodel";
string deploy_file = prototxt_dir + "/deploy.prototxt";
string labelmap_file = trainData_dir + "/labelmap_voc.prototxt";
string result_dir = job_dir + "/result/detect";
string dataset_mean = trainData_dir + "/VOC0712_trainval_mean.binaryproto";//"104,117,123";
string file_type = "video"; // "image" "images" or "video"

...
dataLayer_param = {
    'train_data': "{}/{}_trainval_lmdb".format(trainData_dir, dataset_name),#need to config
    'test_data': "{}/{}_test_lmdb".format(trainData_dir, dataset_name),#need to config
    'num_test_image': 1849,#need to config
    'train_batch_size': 32,#need to config
    'test_batch_size': 8,#need to config
    'label_map_file': "{}/labelmap_RMinfantry.prototxt".format(trainData_dir),#need to config

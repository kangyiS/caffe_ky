...
video:     80fps(forward), 30fps(loop)
one image: 36fps(forward), 23fps(loop)
images:    63fps(forward), 33fps(loop)
...
model_weights = "{}/ssd_RMinfantry_iter_25000.caffemodel".format(trainModel_dir)#need to config
...
#source_file = "/home/kangyi/data/RMinfantry/RMinfantry_chassis/JPEGImages/1.jpg"
source_file = "/home/kangyi/data/RMinfantry/RMinfantry_chassis/JPEGImages"
#source_file = "/home/kangyi/caffe/examples/videos/RMinfantry_videos/video1.mp4"
